...
export const instituto: PropostaData = {
  ...
  portfolio: {
    ...
    link: { label: 'Ver portfólio completo', url: 'https://instagram.com/thiagowessley' },
    itens: [
      ...
      { titulo: 'Social Media', categoria: 'Conteúdo', imagem: '/img/portfolio/p5.jpg' },
      { titulo: 'Landing Page', categoria: 'Web', imagem: '/img/portfolio/p6.jpg' },
      { titulo: 'Vídeo Branding', categoria: 'Audiovisual', imagem: '/img/portfolio/p7.jpg' },
      { titulo: 'Naming', categoria: 'Branding', imagem: '/img/portfolio/p8.jpg' },
      { titulo: 'Campanha', categoria: 'Tráfego', imagem: '/img/portfolio/p9.jpg' },
    ],
  },
