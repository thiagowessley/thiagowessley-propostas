...
export const caridadeSite: PropostaData = {
  ...
  portfolio: {
    ...
    itens: [
      { titulo: 'Direção Criativa', categoria: 'Audiovisual', imagem: '/img/portfolio/p1.webp' },
      ...
      { titulo: 'Degustação', categoria: 'Branded content', imagem: '/img/portfolio/p4.webp' },
      { titulo: 'Casa Calantti', categoria: 'Gastronomia & marca', imagem: '/img/portfolio/p5.webp' },
      ...
      { titulo: 'Reunião Executiva', categoria: 'Registro corporativo', imagem: '/img/portfolio/p8.webp' },
      { titulo: 'Depoimento', categoria: 'Beier Group', imagem: '/img/portfolio/p9.jpg' },
    ],
  },
