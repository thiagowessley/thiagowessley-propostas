...
export const dassgConsultoriaLinhaPlastico: PropostaData = {
  ...
  servico: 'Consultoria Estratégica: Nova Linha de Produtos Pet em Plástico',
  validade: '2026-09-28',
  envio: '2026-09-21',
    ...
    planos: [
      {
        ...
        rodape: 'Preparação já entregue',
      },
    ],
    prazos: [
      { texto: 'A preparação (referências, nomes e roteiro do engenheiro) já foi entregue. Pesquisa, modelo e publicação levam até 15 dias corridos depois da aprovação e do pagamento da primeira parcela.', bold: 'até 15 dias corridos' },
