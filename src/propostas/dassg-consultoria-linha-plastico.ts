...
export const dassgConsultoriaLinhaPlastico: PropostaData = {
  ...
  secoes: {
    cenario: {
      problema: 'Os sócios da Dassg Têmpera validaram em 15/09/2026 a linha de produtos pet em metal e pediram a mesma linha em plástico, o material das referências de produto que eles trouxeram: caixas de areia, fonte de água, comedouro, casinha, arranhador e uma mala de transporte transparente. Falta transformar essa direção em decisão, com número real e sem gastar em molde antes da hora.',
    ...
    prazos: [
      { texto: 'A preparação (referências, nomes e briefing técnico de fabricação) está pronta e será apresentada na reunião de 23/09. Pesquisa, modelo e publicação levam até 15 dias corridos depois da aprovação e do pagamento da primeira parcela.', bold: 'até 15 dias corridos' },
    ...
    pagamento: {
      blocos: [
        { titulo: 'Primeira parcela, 50%', descricao: 'R$ 1.750 na aprovação desta proposta. É ela que libera a parte pesada: pesquisa de fabricação, modelo financeiro e site.' },
        { titulo: 'Segunda parcela, 50%', descricao: 'R$ 1.750 na entrega do catálogo e do plano do plástico publicados.' },
      ],
      meios: [
