  ...
  secoes: {
    ...
    planos: [
      ...
      },
      {
        ...
        resumo: 'Stories ao vivo + entrega expressa',
        itens: [
          'Captação em vídeo, até 1 diária',
          'Edição completa com corte e ritmo',
          'Correção de cor',
          ...
          'Cortes adicionais para Reels e Stories',
          'Versionamento em 9:16 e 1:1',
          'Stories em tempo real durante o evento',
          'Cortes de Reels com entrega acelerada em até 1 dia útil',
          'Aftermovie entregue no mesmo dia ou no dia seguinte',
        ],
        valor: 3897,
        periodo: 'entrega única',
        rodape: 'Aftermovie no mesmo dia ou no dia seguinte ao evento',
      },
    ],
    prazos: [
